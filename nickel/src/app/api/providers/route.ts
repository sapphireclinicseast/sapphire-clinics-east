  ...
  const result = await Promise.all(
    providers.map(async (p) => {
      ...
      return {
        ...
        treatsAdults: p.treatsAdults,
        treatsPedia: p.treatsPedia,
        caseCategories: p.caseCategories ?? [],
        commonCases: p.commonCases ?? [],
        awards: p.awards ?? [],
        pptaNumber: p.pptaNumber ?? null,
        pptaMember: p.pptaMember,
        ...
        priceInitialEval: p.priceInitialEval != null ? Number(p.priceInitialEval) : null,
        priceProgressReport: p.priceProgressReport != null ? Number(p.priceProgressReport) : null,
        priceHEP: p.priceHEP != null ? Number(p.priceHEP) : null,
