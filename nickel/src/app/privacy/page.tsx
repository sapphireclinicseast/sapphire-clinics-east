    ...
    <div className="animate-fade-up mx-auto max-w-2xl">
      <div className="card">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          ...
          <LI><b>Booking &amp; payment records</b> — sessions and consults booked, amounts, and payment status. Card and e-wallet details are entered directly with our payment processor; SCEI never sees or stores your full card number.</LI>
        ...
        <H>Payments</H>
        <P>Payments are processed by <b>PayMongo</b>, our payment channel partner. Your payment is handled on PayMongo’s secure systems under their privacy policy; SCEI receives only confirmation of payment and the method used, not your full card details.</P>
        ...
        <P>Jan De Asis, Data Protection Officer<br />Email: <a className="font-semibold text-[color:var(--steel)] hover:underline" href="mailto:jpdeasis.scei@gmail.com">jpdeasis.scei@gmail.com</a><br />Sapphire Clinics East, Inc. — Robinsons Metro East, Pasig City, Philippines</P>
