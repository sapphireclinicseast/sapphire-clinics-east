...
const ANNEX_A: Annex = {
  ...
  blocks: [
    ...
    { k: 'p', t: 'A1.1  Fifteen per cent (15%). SCEI retains a Platform Fee equal to fifteen per cent (15%) of your Provider Rate for each completed Homecare Session. There is no joining fee, no monthly fee, no listing fee and no charge for declining a Booking.' },
    { k: 'p', t: 'A1.2  What the Platform Fee is charged on. The Platform Fee is charged on your Provider Rate only. Where transportation is charged to the Client separately under Annex D, the transportation amount is passed through to you in full and no Platform Fee is charged on it. Where your Provider Rate is transportation-inclusive, the Platform Fee applies to the whole rate, because the whole rate is your Provider Rate.' },
    { k: 'p', t: 'A1.3  Payment processing charges. The charges levied by the payment provider operating SCEI’s Verdana account are borne by SCEI out of the Platform Fee. They are not deducted from your earnings.' },
    { k: 'p', t: 'A1.4  What SCEI provides for the Platform Fee. Client acquisition and matching, booking and scheduling, online payment collection, remittance and payout administration, tax withholding and BIR Form 2307 issuance, credential verification, the safety and check-in system, clinical documentation tools, client support, and the redress mechanism under Section 11 of the Terms.' },
    { k: 'h', t: 'A2.  How your payout is computed' },
    { k: 'p', t: 'A2.1  For each completed Homecare Session, SCEI computes your payout as: the Session Fee collected from the Client, less the Platform Fee, less the creditable withholding tax required under Clause 10.5 of the Terms, plus any transportation pass-through.' },
    { k: 'p', t: 'A2.2  Worked example 1 — transportation-inclusive rate of PHP 1,500.00' },
    { k: 'table', head: ['Item', 'Amount (PHP)', 'Note'], rows: [
      ['Provider Rate (transportation-inclusive)', '1,500.00', 'set by you'],
      ['Session Fee collected from Client', '1,500.00', ''],
      ['Less: Platform Fee at 15%', '(225.00)', '15% of 1,500.00'],
      ['Less: creditable withholding tax at 5%', '(75.00)', '5% of 1,500.00'],
      ['Net remitted to you', '1,200.00', ''],
    ] },
    { k: 'p', t: 'SCEI issues you BIR Form 2307 for the PHP 75.00 withheld, which you credit against your own income tax.' },
    { k: 'p', t: 'A2.3  Worked example 2 — rate of PHP 1,500.00 plus transportation of PHP 250.00' },
    { k: 'table', head: ['Item', 'Amount (PHP)', 'Note'], rows: [
      ['Provider Rate', '1,500.00', 'set by you'],
      ['Transportation (Annex D, Tier 2)', '250.00', 'pass-through'],
      ['Session Fee collected from Client', '1,750.00', ''],
      ['Less: Platform Fee at 15%', '(225.00)', '15% of 1,500.00 only'],
      ['Less: creditable withholding tax at 5%', '(75.00)', '5% of 1,500.00 only'],
      ['Net remitted to you', '1,450.00', ''],
    ] },
    { k: 'p', t: 'A2.4  Withholding rate. The 5% rate shown applies where your gross professional income for the year does not exceed PHP 3,000,000.00 and you have given SCEI the sworn declaration and BIR Certificate of Registration required by Revenue Regulations No. 11-2018. Without that declaration, or where your income exceeds the threshold, the rate is 10%. It is your responsibility to submit the declaration each year and to tell SCEI if your circumstances change.' },
    ...
    { k: 'p', t: 'A3.5  Payout statement. Each run is accompanied by a statement listing every session, the Session Fee, the Platform Fee, the tax withheld, any transportation pass-through, and any set-off applied under Clause 10.6 of the Terms.' },
