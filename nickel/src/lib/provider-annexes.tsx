...
// JUO" appendix) is intentionally NOT reproduced — only the operative annexes.
//
// Any remaining [●] marks an operational figure JUO has not yet set
...
const ANNEX_A: Annex = {
  ...
  blocks: [
    { k: 'p', t: 'This Annex sets out what JUO deducts, when you are paid, and what happens when a Homecare Session is cancelled, missed or cut short. It is written to be read by Providers, and every figure in it is disclosed to you before you accept a Booking.' },
    { k: 'h', t: 'A1.  The Platform Fee' },
    { k: 'p', t: 'A1.1  A flat PHP 20.00 per session. JUO retains a flat Platform Fee of twenty pesos (PHP 20.00) for each completed Homecare Session, whatever your Provider Rate. There is no percentage commission, no joining fee, no monthly fee, no listing fee and no charge for declining a Booking.' },
    { k: 'p', t: 'A1.2  Payment processing charges (borne by you). Client payments are collected online through the payment channel partner PayMongo, on the Verdana account operated by JUO’s partner SCEI. PayMongo charges a transaction fee (a Merchant Discount Rate, or MDR) on each payment, which varies with the payment method the Client chooses. This processing charge is deducted from the Session Fee before your payout. The prevailing rates are:' },
    ...
    { k: 'p', t: 'A3.1  Weekly. Payouts are made weekly. The cut-off is Sunday at 11:59 pm, and JUO remits the net earnings for all Homecare Sessions completed and documented in that week on the following [Wednesday].' },
    ...
    { k: 'p', t: 'A3.6  Queries. Raise a payout query within thirty (30) days of the payout date, through the Platform. JUO responds within [five (5)] business days.' },
    ...
    { k: 'p', t: 'A4.4  First-time forgiveness. JUO may, once per Client in any twelve (12) month period, waive a late cancellation charge where the reason is a genuine emergency. Where JUO waives the charge, JUO, not you, absorbs the amount payable to you under the table above.' },
    { k: 'h', t: 'A5.  Cancellation by you' },
    { k: 'p', t: 'A5.1  Notice. Cancel through the Platform as early as you can, and at least twenty-four (24) hours before the start time. JUO will attempt to reassign the Booking to another Provider.' },
    { k: 'p', t: 'A5.2  No monetary penalty. JUO does not charge you a cancellation fee. Reliability is managed through your record on the Platform rather than through deductions from your earnings.' },
    ...
    { k: 'p', t: '(a)  three (3) such records prompt a conversation with JUO and may affect your ranking;' },
    ...
    { k: 'p', t: 'A7.2  What happens. The Client is offered a free reschedule or a full refund. Where you had already begun travelling, transportation actually incurred is reimbursed to you by JUO on presentation of proof.' },
    ...
    { k: 'p', t: 'A8.2  Who bears a refund. A refund arising from your act or omission is set off against your payouts under Clause 10.6 of the Terms. A refund arising from a Platform failure, an JUO error, or a force majeure event is borne by JUO.' },
    { k: 'p', t: 'A8.3  Chargebacks. Where a Client initiates a chargeback, JUO notifies you and you provide the documentation needed to respond within [three (3)] business days. Where the chargeback succeeds and the underlying complaint is attributable to you, the amount is set off against your payouts.' },
    { k: 'p', t: 'A8.4  Limit on set-off. JUO will not set off more than fifty per cent (50%) of any single weekly payout, and will carry the balance forward, so that a dispute does not remove a week’s income at once. JUO will not set off an amount that is genuinely disputed until the dispute is resolved under Section 11 of the Terms.' },
    { k: 'h', t: 'A9.  Changes to this Annex' },
    { k: 'p', t: 'A9.1  JUO may change this Annex on at least thirty (30) days’ prior notice by email and in-app, in accordance with Clause 10.8 of the Terms. Changes apply only to Bookings confirmed on or after the effective date, and you may deactivate your account before that date without penalty if you do not accept them.' },
  ],
}
...
const ANNEX_B: Annex = {
  ...
  blocks: [
    ...
    { k: 'p', t: 'B1.2  Arrive within the arrival window. Where you will be late, tell the Client and JUO through the Platform before the start time, not after it.' },
    ...
    { k: 'p', t: 'B3.3  Decline gifts beyond a token courtesy. Food or drink offered during a visit may be accepted. Anything of more than nominal value, and any cash, is declined politely and reported to JUO through the Platform.' },
    ...
    { k: 'p', t: 'B3.5  Do not discuss another Client with anyone, and do not discuss your fees or your arrangements with JUO in a way that invites the Client to transact outside the Platform.' },
    ...
    { k: 'p', t: 'B5.3  Report any concern about abuse, neglect or exploitation under Clause 7.5 of the Terms. If you are unsure whether what you saw meets the threshold, report it anyway and let JUO’s safeguarding contact make that judgment.' },
    ...
    { k: 'p', t: 'B6.3  Answer JUO’s messages about a Booking, a complaint or a safety matter within [two (2)] business days.' },
    ...
    { k: 'h', t: 'B8.  How JUO responds to a concern' },
    ...
    { k: 'p', t: 'B8.1  Your right to be heard. Except where immediate action is needed to protect someone, JUO tells you what has been alleged, gives you a reasonable opportunity to respond, considers your response, and tells you the outcome and the reasons for it.' },
    { k: 'p', t: 'B8.2  Your right to ask for a review. You may ask JUO to review a deactivation under Clause 23.5 of the Terms.' },
    { k: 'p', t: 'B8.3  Speaking up. JUO will not penalise you for reporting a safety concern, a safeguarding concern, a privacy incident, or a problem with the Platform itself, in good faith.' },
  ],
}
...
const ANNEX_C: Annex = {
  ...
  blocks: [
    ...
    { k: 'h', t: 'C2.  What JUO collects and why' },
    { k: 'table', head: ['Category', 'What it includes', 'Purpose and lawful basis'], rows: [
      ...
      ['Professional credentials', 'PRC licence and identification card, PTR, curriculum vitae, training records, specialisations', 'To verify that you are licensed and competent, and to display your credentials to Clients. Necessary for these Terms and for JUO’s legal obligations.'],
      ['Background verification', 'NBI clearance and the results of verification with the PRC and your references', 'To protect Clients, who are often children or unwell adults, in their own homes. Processed with your consent and on the basis of JUO’s legitimate interest in Client safety.'],
      ['Financial and tax', 'Bank account and GCash details, Taxpayer Identification Number, BIR Certificate of Registration, sworn declarations, payout history', 'To pay you and to withhold and remit tax. Necessary for these Terms and for JUO’s legal obligations under the National Internal Revenue Code.'],
    ...
    { k: 'table', head: ['Recipient', 'Why'], rows: [
      ...
      ['Jara Universal OPC', 'Development, hosting support and maintenance of the Platform, as JUO’s personal information processor under a written agreement.'],
      ['The payment provider operating the Verdana account, and your bank or GCash', 'To collect Client payments and remit your earnings.'],
      ['JUO’s professional advisers, auditors and insurers', 'For accounting, tax, audit, legal advice and insurance, under confidentiality.'],
    ...
    { k: 'p', t: 'C4.1  JUO does not sell your personal data and does not share it with advertisers.' },
    { k: 'p', t: 'C4.2  Storage location and transfers. The Platform and its data are hosted at [●]. Where personal data is transferred outside the Philippines, JUO remains accountable for it and puts in place the contractual protections required by the Data Privacy Act.' },
    ...
    { k: 'p', t: 'C8.2  How to exercise them. Write to the Data Protection Officer at the address in Clause C1.2. JUO acknowledges within [five (5)] business days and responds within the period the Data Privacy Act prescribes. JUO may need to verify your identity first, and may decline a request where the law or a retention obligation requires the data to be kept.' },
    { k: 'p', t: 'C8.3  Complaints. If you are not satisfied with JUO’s response you may complain to the National Privacy Commission, 25th to 27th Floors, The Upper Class Tower, Quezon Avenue corner Scout Reyes Street, Quezon City, telephone (02) 5322-1322, using the contact details published at privacy.gov.ph.' },
    ...
    { k: 'p', t: 'C10.1  JUO will notify you of any material change to this notice at least [thirty (30)] days before it takes effect, by email and in the Platform, and will keep prior versions available on request.' },
  ],
}
...
const ANNEX_D: Annex = {
  ...
  blocks: [
    ...
    { k: 'p', t: 'D1.2  Your home base. You nominate one home base — a barangay and city or municipality — from which travel is measured. You may change it once in any [ninety (90)] day period, or more often with JUO’s agreement if you relocate.' },
    ...
    { k: 'p', t: 'D1.4  Local practice requirements. You are responsible for holding a Professional Tax Receipt in each locality where the local government unit requires one of a practising professional, and for any other local permit that applies to your practice. JUO does not obtain these for you.' },
    ...
    { k: 'table', head: ['Tier', 'One-way distance from your base', 'Allowance (PHP)', 'Approval'], rows: [
      ...
      ['Tier 5', 'Requiring air or sea travel, or an overnight stay', 'Actual documented cost, agreed in advance', 'Written pre-approval by JUO'],
    ] },
    { k: 'p', t: 'D2.3  No direct collection. Transportation is collected by JUO as part of the Session Fee and passed through to you in full under Clause A1.2. You may not ask the Client for fuel, fare, parking or any other travel money at the visit.' },
    ...
    { k: 'p', t: 'D3.1  Pre-approval. A Tier 5 Booking proceeds only where JUO has approved it in writing, the Client has agreed the total cost in advance, and the arrangements for travel and accommodation are settled before you depart.' },
    ...
    { k: 'p', t: 'D4.2  Late sessions in unfamiliar areas. Take particular care with sessions ending after dark in an area you do not know, and where transport home is uncertain. JUO will not schedule a session ending after [7:00 pm] in a Tier 4 or Tier 5 area without confirming your return arrangements first.' },
    ...
    { k: 'p', t: 'D4.4  Emergency contacts. Keep an emergency contact current in your account. JUO will use it only if you cannot be reached during or immediately after a Booking.' },
    { k: 'h', t: 'D5.  Changes' },
    { k: 'p', t: 'D5.1  JUO may change the tiers and allowances in this Annex on at least thirty (30) days’ prior notice, in accordance with Clause 10.8 of the Terms. Changes apply only to Bookings confirmed on or after the effective date.' },
  ],
}
