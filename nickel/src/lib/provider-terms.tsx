...
// decision by JUO and its counsel before these terms are finalised.
...
const INTRO: string[] = [
  'These Provider Terms of Service (the "Terms") form a binding agreement between you, the licensed healthcare professional creating a provider account (the "Provider", "you" or "your"), and Jara Universal OPC ("JUO", the "Company", "we", "us" or "our"), a One Person Corporation duly organised and existing under the laws of the Republic of the Philippines, with SEC Registration No. 2026050250486-13 and principal office at 311 Nagoya Felix Avenue, Mayfield Park Residences, Rosario, City of Pasig, Second District, National Capital Region (NCR), 1600.',
  'JUO owns and operates Nickel, a digital platform through which clients book homecare rehabilitation and allied health sessions with independent, PRC-licensed professionals. JUO operates Nickel in partnership with Sapphire Clinics East, Inc. ("SCEI"), a corporation organised under the laws of the Republic of the Philippines with SEC Registration No. 2024040147438-01 and principal office at Units L4205, L4203, L4201, L4199, L4168, L4166 and L4164, 4th Floor, Robinsons Metro East, Marcos Highway, Barangay Dela Paz, 1600 City of Pasig. Under this partnership, SCEI provides clinical support through its Aura Health Rehab clinics (Level 4, Robinsons Metro East, Pasig; and Level 8, GH Tower Offices, Greenhills, San Juan City) and the payment-collection facilities (the Verdana payment account) through which JUO collects Client payments. References in these Terms to acts done by JUO include acts done on JUO’s behalf by its partner SCEI under this arrangement.',
...
const SECTIONS: Section[] = [
  { n: '1', title: 'Definitions and Interpretation', body: [
    ...
    '(h)  "Platform" or "Nickel" means the Nickel mobile application, web application, and related systems and services operated by JUO.',
    '(i)  "Platform Fee" means the fee retained by JUO from each Session Fee, as set out in the Fee Schedule.',
  ...
  { n: '2', title: 'Nature of the Platform and Relationship of the Parties', body: [
    '2.1  Role of JUO. Nickel is a booking, coordination and payment-facilitation platform. JUO does not itself render the professional services booked through Nickel, does not direct or control your clinical judgment, and is not a party to the professional service relationship between you and the Client. That relationship, including the duty of care owed to the Client, is yours.',
    '2.2  Independent contractor. You engage with JUO as an independent professional practitioner and independent contractor. Nothing in these Terms creates an employer-employee, partnership, joint venture, or agency relationship between you and JUO, save for the limited collection agency created by Clause 10.1. In particular:',
    ...
    '(e)  you provide your own equipment, materials, professional supplies and transportation, except where JUO expressly provides them;',
  ...
  { n: '3', title: 'Eligibility, Credentialing and Verification', body: [
    ...
    '3.4  Verification. You authorise JUO to verify the documents and information you submit with the PRC, the NBI, your stated employers, references and other lawful sources, and to re-verify at any time and at least once every twelve (12) months. JUO may refuse, suspend or deactivate an account where verification is incomplete, inconclusive or unsatisfactory.',
    '3.5  Your continuing duty to notify. You will notify JUO in writing within [three (3)] business days of any of the following: the expiry, lapse, suspension, revocation or cancellation of your PRC licence or PTR; any administrative, civil or criminal complaint, investigation or case relating to your professional practice or to the safety of a person in your care; any restriction placed on your scope of practice; any change to the information or documents you submitted; and any circumstance that materially affects your fitness to render homecare services safely.',
  ...
  { n: '4', title: 'Provider Profile, Rates and Listings', body: [
    ...
    '4.6  Moderation. JUO may format, translate, rank and display Provider Content, and may decline to publish or may remove content that is inaccurate, misleading, unlawful, or inconsistent with these Terms, giving you notice and an opportunity to correct it where circumstances permit.',
  ] },
  { n: '5', title: 'Bookings, Scheduling, Cancellation and No-Shows', body: [
    '5.1  How a Booking is formed. A Client requests a Homecare Session through the Platform; the Booking is formed when JUO confirms it in the Platform. Each confirmed Booking is a professional service engagement between you and the Client, facilitated and administered by JUO under these Terms.',
    ...
    '5.3  Punctuality. You will arrive within the arrival window shown in the Platform. If you will be late, you will notify the Client and JUO through the Platform as soon as you know, and in any case before the scheduled start time.',
    ...
    '5.6  Client no-show. If the Client is not present or does not admit you at the scheduled time, you will wait at least [thirty (30)] minutes, attempt to contact the Client and JUO through the Platform, and record the no-show in the Platform. Compensation for a recorded no-show is governed by Annex A.',
    ...
    '5.8  Your right to end a session. You may decline to begin, or may end, a Homecare Session where you reasonably believe that continuing would be unsafe, clinically inappropriate, or would expose you to abuse, harassment or intoxicated or threatening behaviour. You will leave promptly, ensure the Client is not left in immediate danger, and report to JUO within [twenty-four (24)] hours. You will be compensated in accordance with Annex A.',
  ...
  { n: '6', title: 'Professional and Clinical Standards', body: [
    '6.1  Professional responsibility. You are solely and professionally responsible for the assessment, plan of care, clinical decisions, execution and documentation of every Homecare Session you render. JUO does not supervise, direct or override your clinical judgment.',
    ...
    '6.5  Escalation and emergencies. You will recognise and act on findings that require referral, and will refer the Client to a physician or appropriate service where indicated. In an emergency you will activate local emergency services, remain with the Client so far as is safe, and notify JUO and the Client Representative as soon as practicable, and in any case within [two (2)] hours.',
    '6.6  Limits. You will not diagnose or manage conditions outside your scope of practice, prescribe or dispense medication, hold yourself out as a physician, or represent yourself as an employee of JUO or of Aura Health Rehab.',
  ...
  { n: '7', title: 'Clients Who Are Minors or Who Require a Substitute Decision-Maker', body: [
    ...
    '7.5  Safeguarding and reporting. If you have reasonable grounds to believe that a Client is being abused, neglected or exploited, you will take the steps required of you by law, including under Republic Act No. 7610 (Special Protection of Children Against Abuse, Exploitation and Discrimination), Republic Act No. 9262 (Anti-Violence Against Women and Their Children), and Republic Act No. 9994 (Expanded Senior Citizens Act), and will report the matter to the appropriate authorities and to JUO’s designated safeguarding contact within [twenty-four (24)] hours.',
    '7.6  No retaliation. JUO will not deactivate, penalise or reduce the Bookings of a Provider for making a report under Clause 7.5 in good faith.',
  ] },
  { n: '8', title: 'Safety During Home Visits', body: [
    '8.1  Information before the visit. JUO will make available to you, through the Platform, the Client’s address, contact details, the service booked, and any access or hazard information the Client has disclosed. JUO does not inspect Clients’ homes and does not warrant that they are safe or suitable.',
    ...
    '8.4  Incident reporting. You will report to JUO through the Platform, within [twenty-four (24)] hours, any injury to a Client or to yourself, any adverse event, any damage to property, and any threatening, abusive or inappropriate conduct.',
  ...
  { n: '9', title: 'Clinical Documentation and Records', body: [
    '9.1  Documentation. You will document each Homecare Session accurately, contemporaneously and completely in the Platform, using the templates JUO provides, and will not alter a record after the fact except by a dated and attributed addendum.',
    '9.2  Records held by JUO. Client records created through Nickel are maintained by JUO as Personal Information Controller for and on behalf of the Client. You retain a professional right of access to the records of Clients you have served, for continuity of care, for the defence of a claim, and for PRC, NPC or judicial proceedings, subject to Section 13.',
    '9.3  Retention. JUO will retain Client records for at least [ten (10)] years from the date of the last Homecare Session, or for such longer period as may be required by law, by DOH issuance, or by a pending or reasonably anticipated claim, after which they will be securely disposed of.',
    ...
    '9.5  Cooperation. You will cooperate promptly and fully with any lawful request, subpoena, PRC or NPC proceeding, quality review, or Client data subject request routed to you by JUO.',
  ] },
  { n: '10', title: 'Fees, Collection, Payouts and Taxes', body: [
    '10.1  Collection by JUO. Client payments for Bookings are collected online by JUO through the Verdana payment account operated by its partner SCEI. JUO collects the Session Fee as your limited collection agent for this purpose only, and payment by the Client discharges the Client’s obligation to pay you for that Homecare Session.',
    ...
    '10.3  Platform Fee. JUO retains a flat Platform Fee of twenty pesos (PHP 20.00) for each Homecare Session, regardless of your Provider Rate. There is no percentage commission, no joining fee, no monthly fee and no charge for declining a Booking. Separately, the payment processing charges levied by JUO’s payment channel partner (PayMongo) on each transaction are deducted from the Session Fee before remittance to you, as set out in Annex A; these vary with the payment method the Client chooses. You therefore receive your Provider Rate less the flat PHP 20.00 Platform Fee and less the applicable payment processing charge. The Fee Schedule states in full what is deducted and how each deduction is computed, and the in-app calculator shows your net for each payment method before you set your rate.',
    '10.4  Payouts. JUO will remit your net earnings to the bank account and/or GCash details recorded in your account weekly, subject to a minimum payout threshold of PHP 500. You are responsible for the accuracy and currency of your payout details, and JUO is not liable for funds remitted to details you supplied incorrectly.',
    '10.5  Taxes. You are an independent professional. JUO acts only as an online platform and limited collection agent, and does not deduct or withhold income tax from your earnings; the only amounts JUO deducts are the flat Platform Fee and the payment processing charge under Clause 10.3. You are solely responsible for registering with the Bureau of Internal Revenue, issuing invoices or official receipts where required, filing your own returns, and paying your own income tax and percentage tax or value-added tax as applicable to your earnings on the Platform. Where JUO is at any time legally required to withhold tax on your earnings, it will do so at the rate required by the National Internal Revenue Code and applicable BIR regulations and will issue you the corresponding BIR certificate, and it may request your Taxpayer Identification Number and any sworn declaration needed to apply the correct rate.',
    '10.6  Set-off. JUO may set off against amounts payable to you: refunds and chargebacks attributable to your act or omission; amounts payable by you under Annex A; overpayments; and any other amount you owe JUO under these Terms. JUO will itemise any set-off in your payout statement.',
  ...
  { n: '11', title: 'Refunds, Chargebacks and Client Disputes', body: [
    ...
    '11.2  Redress mechanism. JUO maintains a redress mechanism for Clients and Providers as required by Republic Act No. 11967. You will participate in it in good faith and will respond to a request for your account of events within [five (5)] business days.',
    '11.3  Allocation. Where a refund or credit is attributable to your act or omission, the amount refunded may be set off against your payouts under Clause 10.6. Where it is attributable to JUO or to the Platform, JUO bears it.',
    '11.4  Chargebacks. Where a Client initiates a chargeback, JUO will notify you and you will provide the documentation needed to respond within [three (3)] business days.',
    '11.5  Clinical complaints. A complaint alleging harm, professional misconduct, or a breach of Client privacy is handled under Sections 15, 21 and 23 and under Annex B. JUO may suspend your account for the duration of an investigation, and will tell you the substance of the allegation and give you a fair opportunity to respond.',
  ] },
  { n: '12', title: 'Non-Circumvention and Off-Platform Engagements', body: [
    ...
    '12.2  What this clause does not restrict. Clause 12.1 does not apply to: a person you can show you were already serving before the introduction; services of a kind not offered through Nickel; a Client you serve in the course of your employment or clinic practice by a lawful referral not arising from the introduction; or any engagement JUO approves in writing. Nothing in this Section restricts your right to practise your profession, to work for any employer, or to use any other platform.',
    '12.3  Remedy. Where you engage a Client in breach of Clause 12.1, JUO may recover the Platform Fees it would have earned on the circumvented sessions, and may suspend or deactivate your account. This is without prejudice to any other remedy.',
  ] },
  { n: '13', title: 'Data Privacy and Protection of Client Information', body: [
    '13.1  Roles of the parties. For Client Personal Data processed through Nickel, JUO is the Personal Information Controller. You process Client Information as a licensed professional exercising independent clinical judgment, and to that extent as a Personal Information Controller in your own right; where you process Client Information on JUO’s documented instructions within the Platform, you do so as a Personal Information Processor. Both parties will comply with the Data Privacy Act of 2012 and its Implementing Rules and Regulations, DOH Administrative Order No. 2020-0030, the Health Privacy Code, and applicable NPC circulars.',
    ...
    '13.8  No secondary use. You will not use Client Information for research, publication, teaching, case presentation, marketing, or the training or evaluation of any artificial intelligence or machine learning system, without JUO’s prior written approval and the Client’s separate documented consent.',
    '13.9  Disclosure. You will not disclose Client Information to any third party without the Client’s consent or another lawful basis, such as a court order or a disclosure required by law. Where you are compelled to disclose, you will notify JUO before disclosing unless the law forbids you to.',
    ...
    '13.11  Cooperation. You will cooperate with JUO’s privacy impact assessments, audits, security reviews, and with any NPC inquiry, and will implement the reasonable organisational, physical and technical measures JUO specifies.',
  ...
  { n: '14', title: 'Confidentiality', body: [
    '14.1  Confidential Information means all Client Information, and all non-public information of JUO disclosed to you in connection with the Platform, including fee arrangements, business plans, unreleased features, provider and client lists, and the content of investigations.',
    ...
    '14.3  Exceptions. Clause 14.2 does not apply to information that is or becomes public other than through your breach, that you can show you held free of obligation before disclosure, or that you are required by law or by a competent authority to disclose, provided that you notify JUO in advance where you are permitted to.',
    '14.4  Duration. Your obligations continue for [five (5)] years after deactivation in respect of JUO business information, and indefinitely in respect of Client Information.',
  ] },
  { n: '15', title: 'Security Incidents and Personal Data Breach Reporting', body: [
    '15.1  Report immediately. You will report to JUO’s Data Protection Officer, promptly and in any case within [twenty-four (24)] hours of becoming aware, any suspected or actual security incident or Personal Data Breach, including a lost or stolen device, a misdirected message, an unauthorised access or disclosure, a suspected phishing attempt, and any disclosure of Client Information outside the Platform.',
    '15.2  What to report. Your report should describe what happened, when, what information was involved, how many Clients may be affected, and what you have done. You will preserve all evidence, will not attempt your own investigation or remediation beyond securing the information, and will not notify the affected Client directly unless JUO asks you to.',
    '15.3  JUO’s role. JUO leads the assessment of every reported incident and, where the Data Privacy Act and NPC Circular No. 16-03 require it, notifies the National Privacy Commission and the affected Data Subjects within seventy-two (72) hours of knowledge of the breach.',
    ...
    '15.5  Good faith reporting. JUO will not penalise a Provider for the prompt, good-faith report of an incident the Provider caused; failing to report, or delaying a report, is treated far more seriously than the incident itself.',
  ] },
  { n: '16', title: 'Insurance', body: [
    '16.1  Professional indemnity. JUO strongly encourages, but does not require, you to obtain and maintain professional indemnity insurance covering your practice of your profession in the Philippines, including homecare. Where you hold such cover, you will provide evidence of it on request. JUO may make professional indemnity cover a mandatory condition of participation on reasonable prior notice.',
    '16.2  No cover by JUO. JUO’s own insurance does not cover you, your acts or omissions, or your property. You are responsible for insuring your own equipment and your own travel.',
  ] },
  { n: '17', title: 'Intellectual Property', body: [
    '17.1  Platform property. JUO owns or licenses the Platform, its software, design, databases, and the "Nickel" mark, together with all related intellectual property. The "Aura Health Rehab" and "Sapphire Clinics East" marks belong to JUO’s partner SCEI and are used under the partnership.',
    '17.2  Licence to you. JUO grants you a limited, revocable, non-exclusive, non-transferable and non-sublicensable licence to use the Platform for the sole purpose of offering and rendering Homecare Sessions under these Terms.',
    '17.3  Licence to JUO. You grant JUO a non-exclusive, royalty-free, worldwide licence to host, store, reproduce, adapt, translate and display your Provider Content for the operation, marketing and promotion of Nickel. The licence ends on deactivation of your account, save for copies retained in archives and in materials already published or distributed.',
    '17.4  Feedback. Suggestions you give JUO about the Platform may be used freely and without obligation.',
    '17.5  Use of JUO marks. You will not use JUO’s marks except as the Platform provides, and will not describe yourself as an employee, agent or representative of JUO or of Aura Health Rehab.',
  ] },
  { n: '18', title: 'Acceptable Use and Account Security', body: [
    '18.1  Your account. You may hold one provider account. You are responsible for your credentials and for all activity under your account, will not share or transfer them, will enable any multi-factor authentication JUO offers, and will notify JUO immediately of any unauthorised use.',
    '18.2  Prohibited conduct. You will not: scrape, crawl or extract Platform data; reverse engineer or attempt to derive the source code of the Platform; circumvent or test its security; introduce malicious code; automate access; create or accept a Booking that is not genuine; manipulate ratings or search ranking; use the Platform to market other services; or harass any user or JUO personnel.',
  ...
  { n: '19', title: 'Ratings, Reviews and Feedback', body: [
    '19.1  Client reviews. Clients may rate and review Homecare Sessions. Reviews are published on your profile in accordance with JUO’s moderation policy.',
    ...
    '19.3  Moderation. JUO will remove a review that is defamatory, discloses Client health information, or breaches these Terms, and will consider a request from you to do so, but does not undertake to remove a review merely because it is unfavourable.',
  ...
  { n: '20', title: 'Representations and Warranties', body: [
    ...
    '20.3  No inducements. You will not give or receive any commission, kickback or other inducement for the referral of a Client, and will disclose to JUO and to the Client any financial interest you hold in a product, device or service you recommend.',
  ] },
  { n: '21', title: 'Indemnity', body: [
    '21.1  By you. You will indemnify and hold harmless JUO, its directors, officers, employees and agents against any claim, loss, liability, penalty, and reasonable cost and legal fee arising out of: your professional acts or omissions in rendering Homecare Sessions; your breach of these Terms; your breach of the Data Privacy Act or of Section 13 or 14; any tax or contribution you were required to pay and did not; and your infringement of a third party’s rights.',
    '21.2  By JUO. JUO will indemnify and hold you harmless against any claim, loss, liability and reasonable cost arising out of JUO’s own gross negligence or wilful misconduct in operating the Platform, or JUO’s breach of these Terms.',
  ...
  { n: '22', title: 'Disclaimers and Limitation of Liability', body: [
    '22.1  Platform provided as is. The Platform is provided on an "as is" and "as available" basis. JUO does not warrant that it will be uninterrupted, error-free or secure against every threat, and may modify, suspend or discontinue any feature on reasonable notice.',
    '22.2  Client-supplied information. JUO does not verify and does not warrant the accuracy of information supplied by Clients, including health history, home conditions and access arrangements.',
    '22.3  Cap. To the fullest extent permitted by Philippine law, JUO’s aggregate liability to you arising out of or in connection with these Terms will not exceed the total Platform Fees JUO retained from your Bookings during the [six (6)] months immediately preceding the event giving rise to the claim.',
  ...
  { n: '24', title: 'Changes to These Terms', body: [
    '24.1  Amendment. JUO may amend these Terms and the Annexes. JUO will give at least [thirty (30)] days’ prior notice of any material change, by email to the address on your account and by notice in the Platform, and will make the amended version available for review before it takes effect.',
  ...
  { n: '25', title: 'Notices', body: [
    ...
    '25.4  Partner clinic offices. The Aura Health Rehab clinics of JUO’s partner SCEI are Aura Health Rehab – East, Level 4, Robinsons Metro East, Marcos Highway, Brgy. Dela Paz, Santolan, Pasig, telephone (02) 5310-4991; and Aura Health Rehab – Greenhills, Level 8, GH Tower Offices, South Drive, Ortigas Avenue, Greenhills, San Juan City, telephone (02) 8529-1590.',
  ] },
  ...
  { n: '27', title: 'General Provisions', body: [
    '27.1  Entire agreement. These Terms and the Annexes are the entire agreement between you and JUO on their subject matter and supersede all prior discussions and representations, save for any fraudulent misrepresentation.',
    '27.2  Assignment. You may not assign or transfer your rights or obligations. JUO may assign to an affiliate or to a successor in its business on notice to you.',
    ...
    '27.7  Language. These Terms are made in English. JUO may make a Filipino translation available for convenience; in the event of conflict, the English version prevails.',
    ...
    '27.9  Relationship to other agreements. These Terms do not vary any separate employment, consultancy or clinic agreement between you and JUO, and no such agreement varies these Terms.',
  ] },
]
