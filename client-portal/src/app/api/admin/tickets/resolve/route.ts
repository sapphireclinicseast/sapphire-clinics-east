// POST /api/admin/tickets/resolve — admin resolves/reopens a patient ticket.
// Admin-cookie gated, forwards to marketing /api/aurora-admin/tickets/resolve
// with the shared AURORA_ADMIN_TOKEN.
...
export async function POST(req: NextRequest) {
  ...
  try {
    const res = await fetch(`${UPSTREAM}/api/aurora-admin/tickets/resolve`, {
      method: 'POST',
