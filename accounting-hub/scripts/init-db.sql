...
-- Enums
DO $$ BEGIN
  CREATE TYPE "Role" AS ENUM ('ADMIN', 'ACCOUNTANT', 'VIEWER', 'AHEA_ADMIN', 'AHGH_ADMIN', 'VERDANA_ADMIN');
...
-- Add new role values
DO $$ BEGIN
  ALTER TYPE "Role" ADD VALUE IF NOT EXISTS 'AHEA_FRONTDESK';
  ALTER TYPE "Role" ADD VALUE IF NOT EXISTS 'AHGH_FRONTDESK';
