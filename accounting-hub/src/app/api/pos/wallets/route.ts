  ...
  const [wallets, total] = await Promise.all([
    prisma.digitalWallet.findMany({
      ...
      include: {
        ...
        ...(walletType === 'PACKAGE' ? { packages: { select: { id: true, department: true, serviceName: true, serviceId: true, isActive: true, totalSessions: true, usedSessions: true, amountPaid: true }, orderBy: { createdAt: 'desc' as const } } } : {}),
      },
    }),
