  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-start justify-center pt-8 overflow-y-auto">
      <div className="bg-white rounded-2xl p-6 shadow-xl w-full max-w-2xl mb-8 relative">
        ...
        {/* The whole point of the flag: payroll can only pay the mentor if the
            "Mentorship" service is on the order. Nothing enforces it — by
            design, so a missing service never stands between a cashier and a
            paying patient — so it has to be visible when services are picked. */}
        {prefill?.withMentor && (
