    ...
    <div className="max-w-5xl mx-auto">
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="text-center mb-4">
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#ED6823]/10 text-[#ED6823] text-[13px] font-semibold">
      ...
      <div className="mt-8 p-4 rounded-2xl bg-[var(--pale-teal)] border border-[var(--light-gray)] flex items-start gap-3">
        ...
        <div className="text-[12px] text-[var(--mid-gray)] leading-relaxed">
          <strong className="text-[var(--deep-teal)]">Disclaimer:</strong> These are actual comments from patients who were randomly chosen to participate in our customer survey. All responses are anonymous.
          {strengths.length === 0 && (
