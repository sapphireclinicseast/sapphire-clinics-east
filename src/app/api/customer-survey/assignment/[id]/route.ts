    ...
    sections: [
      {
        ...
        questions: [
          { id: 'q1', text: "To what extent do you agree that the clinician has understood and effectively addressed the patient's needs and concerns?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
          { id: 'q2', text: "How would you rate the consistency and effectiveness of communication with the clinician regarding the patient's progress and goals?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
          { id: 'q3', text: "To what extent do you agree that the patient has shown improvement in their overall well-being since starting this service?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
          { id: 'q4', text: "How would you rate the quality of the therapeutic relationship and interactions during sessions (with the clinician, and with peers where applicable)?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
          { id: 'q5', text: "To what extent do you agree that the patient's communication, physical, or daily-living skills have developed positively during their time in this service?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
          { id: 'q6', text: "To what extent do you agree that the patient has shown improvement in their behavior, cooperation, or engagement during sessions?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
          { id: 'q7', text: "To what extent do you agree that the patient has shown measurable progress in the specific areas targeted by this service (e.g., movement, speech, learning, behavior, or health)?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
          { id: 'q8', text: "How well do you feel informed about the patient's treatment or care plan, goals, and progress?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Strongly Disagree', right: 'Strongly Agree' } },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        questions: [
          ...
          { id: 'q10', text: "If a home program, exercises, or follow-up instructions were provided, how clear and easy to follow were they?", type: 'rating', scale: { steps: 6, startAtOne: false, left: 'Very Difficult', right: 'Very Easy' } },
