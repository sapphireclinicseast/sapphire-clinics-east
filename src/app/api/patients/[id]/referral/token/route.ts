// POST /api/patients/[id]/referral/token
// Generates a one-time upload token for the mobile QR code flow.
// Returns the token + a QR code data URL.
...
export async function POST(
  ...
  await prisma.referralUploadToken.deleteMany({
  ...
  await prisma.referralUploadToken.create({
