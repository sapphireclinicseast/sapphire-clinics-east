// The accepted fellow's UGAT Fellowship Agreement signing (Part III).
  ...
  try {
    ...
    if (sch) {
      ...
      if (pdf) {
        ...
        await prisma.ugatUpload.create({ data: { scholarId: c.scholarId, kind: 'RSA_PDF', filename: 'UGAT-Fellowship-Agreement-Signed.pdf', mimeType: 'application/pdf', data: pdf } })
