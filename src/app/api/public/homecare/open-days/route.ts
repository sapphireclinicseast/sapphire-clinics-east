// GET /api/public/homecare/open-days?cityId=&branch= — upcoming concrete dates
// (expanded from the recurring weekly rules, with remaining seats) for a city +
// serving branch. Feeds the date-picker step of the /homecare flow.

import { NextRequest, NextResponse } from 'next/server'
import { preflight, withCors } from '../../_cors'
import { upcomingOccurrences, isShortBranch } from '@/lib/homecare'
