            ...
            <div className={s.card}>
              ...
              <div className={s.mobileProgram}>
                <p className={s.mobileProgramDesc}>
                  The UGAT Fellowship Program is a fully forgivable fellowship loan for Allied Health
