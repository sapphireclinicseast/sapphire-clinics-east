...
const FAQS: { q: string; a: React.ReactNode }[] = [
  {
    ...
    a: <>The fellowship has two tracks. The <b>Aral Track</b> is for <b>final-year interns</b> still undergoing their clinical internship — fellowship assistance released as a monthly allowance (₱5,000 or ₱10,000) for 5–10 months. The <b>Tindig Track</b> is for <b>graduates preparing for the Licensure Examination</b> who have completed their internship and were not Aral awardees — ₱30,000 of review support (review fees, or ₱5,000/month for six months). It is <b>educational fellowship assistance</b> that is <b>fully condonable</b>: after you are licensed, render your return-service hours with us — <b>1,500</b> for the Aral Track, <b>600</b> for the Tindig Track — and it is written off in full, you pay nothing, no interest. If you'd rather reimburse, you pay back only what you received, interest-free (interest or a small penalty applies only after an uncured default). When you apply, you&rsquo;ll first choose the track that fits you.</>,
  },
  {
  ...
  },
  {
    ...
    a: <>After you are licensed, you settle it one of two ways. <b>Option A — render your service:</b> render your return-service hours at <b>Aura Health Rehab</b> as a fully-compensated licensed clinician — <b>1,500 patient-session hours</b> for the Aral Track, <b>600</b> for the Tindig Track (beginning within <b>60 days</b> of receiving your license) — and the entire amount is <b>condoned</b>, you pay nothing. <b>Option B — Reimbursement:</b> reimburse <b>only what you actually received</b>, in equal monthly installments (3 months up to ₱50,000, 6 months above; Tindig is always 3 months), <b>interest-free</b>. Interest or a penalty applies only after an uncured default. Service is never compelled; Option A is simply the path designed to cost you nothing. Because service is rendered on-site, please make sure you can reach and work at Aura Health Rehab&rsquo;s clinic locations.</>,
  },
  {
    q: 'If I render service at the accredited partner clinics, is my professional compensation deducted?',
    a: <>No. Under Option A, the service is fulfilled through the <b>hours you actually work — not through any salary deduction</b>, and you are fully and separately compensated for that work. In practice, you simply report for your regular clinical schedule (about five days a week) at an accredited partner clinic until your return-service hours are completed — <b>1,500 hours</b> for the Aral Track, <b>600 hours</b> for the Tindig Track. <br /><br />As a rough estimate, at about <b>six patient sessions a day, five days a week</b> — roughly 30 hours a week, or about 130 hours a month — the Aral Track&rsquo;s 1,500 hours take approximately <b>11 to 12 months</b> (a little under a year), and the Tindig Track&rsquo;s 600 hours about <b>5 months</b>. Your actual pace depends on your caseload and schedule.</>,
  },
  {
  ...
  {
    q: 'Does my school need to be a partner school for me to apply?',
    a: <>No — you can <b>apply on your own</b>. Applications are <b>no longer coursed through your school</b>, and your school does <b>not</b> need to be a partner. For <b>both tracks</b>, all that matters is your program: if you are a <b>final-year intern in</b> (Aral Track) or a <b>graduate of</b> (Tindig Track) an <b>SLP or OT program we accept fellows in</b>, you may apply <b>directly to SCEI</b>. If you have any questions, feel free to write to us at <a href="mailto:fellowship@sapphireclinicseast.org">fellowship@sapphireclinicseast.org</a> and we&rsquo;ll be glad to help.</>,
  },
]
