    ...
    <div className="max-w-3xl mx-auto">
        ...
        <div className="card-static animate-gate mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
            ...
            <button
              ...
              className="flex flex-col items-start gap-2 p-4 rounded-xl border-2 border-[#A85C3D]/30 bg-[#A85C3D]/5 hover:border-[#A85C3D] hover:bg-[#A85C3D]/10 transition-all text-left"
            >
              <ClipboardList size={20} style={{ color: '#A85C3D' }} />
              <span className="font-bold text-[14px] text-[var(--charcoal)]" style={{ fontFamily: 'var(--font-display)' }}>
        ...
        <div className="card-static animate-gate mb-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="btn-primary flex-1 py-3 rounded-xl !bg-gradient-to-r !from-[#A85C3D] !to-[#C69849]"
            >
              {submitting ? <Loader2 size={16} className="animate-spin" /> : <CheckCircle2 size={16} />}
      ...
      {actionMode === 'complete' && supportsIEFlag && ieMode === 'DAILY_NOTES' && session.patient && (
        <div className="mb-3 rounded-xl border-2 border-[#C69849]/30 bg-[#C69849]/5 px-4 py-3 flex items-center gap-3 animate-fade-up">
          <ClipboardList size={16} style={{ color: '#A85C3D' }} className="shrink-0" />
          ...
          <button
            ...
            className="text-[12px] font-semibold whitespace-nowrap px-3 py-1.5 rounded-lg bg-[#A85C3D] text-white hover:bg-[#C69849] transition-colors"
          >
            Switch to IE upload
          </button>
        </div>
