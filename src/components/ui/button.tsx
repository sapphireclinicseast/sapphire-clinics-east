...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--primary)] text-white shadow-sm hover:bg-[#d45c1f] active:scale-[0.98]",
        secondary:
          "bg-[var(--secondary)] text-white shadow-sm hover:bg-[#264e4a] active:scale-[0.98]",
        destructive:
          "bg-[var(--destructive)] text-white shadow-sm hover:bg-red-700 active:scale-[0.98]",
        outline:
          "border border-[var(--border)] bg-white text-[var(--foreground)] shadow-sm hover:bg-[var(--muted)] hover:text-[var(--foreground)]",
        ghost:
