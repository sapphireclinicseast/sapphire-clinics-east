...
function aralBlocks(i: PdfInput): Block[] {
  ...
  return [
    ...
    P("2.4 Cut-Short of Internship. Should the FELLOW be unable to continue or complete the internship for any reason, the Allowance ceases as of the date of discontinuance, and the FELLOW and CO-MAKER agree to reimburse the Allowance actually received plus a ten percent (10%) surcharge within ninety (90) days. Full reimbursement finally settles the Parties' obligations. SCEI may, with compassion, waive, reduce, or restructure the reimbursement — particularly for serious illness, a death in the immediate family, or circumstances beyond the FELLOW's control."),
...
function tindigBlocks(i: PdfInput): Block[] {
  ...
  return [
    ...
    P("2.4 Discontinuance of Review. Should the FELLOW abandon or discontinue the review, or fail to sit for the Licensure Examination as required, further disbursements cease as of the date of discontinuance, and the FELLOW and CO-MAKER agree to reimburse the Grant actually received plus a ten percent (10%) surcharge within ninety (90) days. Full reimbursement finally settles the Parties' obligations. SCEI may, with compassion, waive, reduce, or restructure the reimbursement — particularly for serious illness, a death in the immediate family, or circumstances beyond the FELLOW's control."),
...
function commonBlocks(i: PdfInput, consideration: string, regardless: string): Block[] {
  ...
  return [
    ...
    P('6.1 Cash Buyout. Should the FELLOW elect not to render, or be unable to complete, the obligation, it may be discharged through a cash payment equal to the unrendered hours multiplied by an Hourly Credit Rate (PHP 150.00 per hour), plus a flat ten percent (10%) surcharge. By illustration, the buyout for the full 1,500 hours equals PHP 225,000.00 plus the 10% surcharge, totaling PHP 247,500.00.'),
