...
export const HOLIDAY_THEMES: Record<string, HolidayTheme> = {
  ...
  'new year':       { bgGradient: 'linear-gradient(135deg,#0D5B68 0%,#0a1012 100%)',  accent: '#C9A227', textColor: '#FFFFFF', emoji: '🎆', decorEmoji: '✨' },
  'bagong taon':    { bgGradient: 'linear-gradient(135deg,#0D5B68 0%,#0a1012 100%)',  accent: '#C9A227', textColor: '#FFFFFF', emoji: '🎆', decorEmoji: '✨' },
  valentine:        { bgGradient: 'linear-gradient(135deg,#2d0a18 0%,#4a1a2a 100%)',  accent: '#E91E8C', textColor: '#FFFFFF', emoji: '❤️', decorEmoji: '💕' },
  easter:           { bgGradient: 'linear-gradient(135deg,#E4F3F5 0%,#d0eef2 100%)',  accent: '#1A7B8A', textColor: '#1C2B30', emoji: '🐣', decorEmoji: '🌸' },
  'holy week':      { bgGradient: 'linear-gradient(135deg,#1a0a2e 0%,#2e1a0a 100%)',  accent: '#C9A227', textColor: '#FFFFFF', emoji: '✝️', decorEmoji: '🙏' },
  'semana santa':   { bgGradient: 'linear-gradient(135deg,#1a0a2e 0%,#2e1a0a 100%)',  accent: '#C9A227', textColor: '#FFFFFF', emoji: '✝️', decorEmoji: '🙏' },
  halloween:        { bgGradient: 'linear-gradient(135deg,#120800 0%,#2a1200 100%)',   accent: '#FF6B00', textColor: '#FFFFFF', emoji: '🎃', decorEmoji: '🕷️' },
  thanksgiving:     { bgGradient: 'linear-gradient(135deg,#2a1200 0%,#3a1a00 100%)',   accent: '#C9A227', textColor: '#FFFFFF', emoji: '🦃', decorEmoji: '🍂' },
  ...
  'labor day':        { bgGradient: 'linear-gradient(135deg,#0D5B68 0%,#1A7B8A 100%)',accent: '#C9A227', textColor: '#FFFFFF', emoji: '💪', decorEmoji: '🌟' },
  ...
  undas:              { bgGradient: 'linear-gradient(135deg,#1a0a2e 0%,#0d0818 100%)', accent: '#C9A227', textColor: '#FFFFFF', emoji: '🕯️', decorEmoji: '🌸' },
  'all saints':       { bgGradient: 'linear-gradient(135deg,#1a0a2e 0%,#0d0818 100%)', accent: '#C9A227', textColor: '#FFFFFF', emoji: '🕯️', decorEmoji: '🌸' },
  'all souls':        { bgGradient: 'linear-gradient(135deg,#1a0a2e 0%,#0d0818 100%)', accent: '#C9A227', textColor: '#FFFFFF', emoji: '🕯️', decorEmoji: '🌸' },
  ...
  eid:                { bgGradient: 'linear-gradient(135deg,#1a3a0d 0%,#0d2206 100%)', accent: '#C9A227', textColor: '#FFFFFF', emoji: '🌙', decorEmoji: '⭐' },
  ...
  "father's day":     { bgGradient: 'linear-gradient(135deg,#0D5B68 0%,#0a1012 100%)', accent: '#C9A227', textColor: '#FFFFFF', emoji: '👔', decorEmoji: '⭐' },
  'fathers day':      { bgGradient: 'linear-gradient(135deg,#0D5B68 0%,#0a1012 100%)', accent: '#C9A227', textColor: '#FFFFFF', emoji: '👔', decorEmoji: '⭐' },
  default:            { bgGradient: 'linear-gradient(135deg,#0D5B68 0%,#0a1012 100%)', accent: '#C9A227', textColor: '#FFFFFF', emoji: '🎉', decorEmoji: '✨' },
}
...
function birthdayElegant(staffName: string, photoUrl: string, greeting: string): string {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .left-brand-text{font-family:'Montserrat',sans-serif;font-size:11px;font-weight:700;
...
function birthdayBold(staffName: string, photoUrl: string, greeting: string): string {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .name{font-family:'Montserrat',sans-serif;font-size:70px;font-weight:900;color:#fff;
...
export function generateHolidayCardHTML(params: {
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box;}
    body{width:1080px;height:1080px;overflow:hidden;font-family:'Open Sans',sans-serif;}
    ...
    .pre-label{font-family:'Montserrat',sans-serif;font-size:14px;font-weight:700;
      letter-spacing:0.4em;text-transform:uppercase;color:${theme.accent};margin-bottom:14px;position:relative;z-index:2;}
    .holiday-name{font-family:'Montserrat',sans-serif;font-size:78px;font-weight:900;
    ...
    .footer-text{font-family:'Montserrat',sans-serif;font-size:12px;font-weight:700;
