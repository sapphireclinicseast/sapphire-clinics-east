...
// or repayable in cash at a flat 10% for the Repayment Period (Option B) — plus Annex A.
...
export function loanAgreementBlocks(i: LoanInput): LoanBlock[] {
  ...
  const defsAndSec2: LoanBlock[] = isTindig ? [
    ...
    { lead: 'Interest.', text: 'A flat interest charge equal to ten percent (10%) of the Principal for the three (3)-month Repayment Period — equivalent to forty percent (40%) per annum — which applies only under the Cash Repayment Option and only from the Repayment Commencement Date (Section 6). No interest of any kind accrues under the Service Condonation Option.' },
    ...
    { lead: 'Interest.', text: 'A flat interest charge equal to ten percent (10%) of the Principal for the six (6)-month Repayment Period — equivalent to twenty percent (20%) per annum — which applies only under the Cash Repayment Option and only from the Repayment Commencement Date (Section 6). No interest of any kind accrues under the Service Condonation Option.' },
    { lead: 'Service Condonation Option (Option A).', text: 'The FELLOW’s option to discharge the Loan in full — entire Principal and all Interest condoned and waived — by rendering the Service Hours under an Engagement Contract (Section 5).' },
    ...
    { lead: 'Service Hours.', text: 'One Thousand Five Hundred (1,500) hours of direct patient treatment sessions rendered as a licensed professional at any SCEI clinic, ordinarily completed within approximately fifteen (15) to eighteen (18) months at typical clinical loads (Section 5.2).' },
    { lead: 'Repayment Commencement Date.', text: 'The date falling sixty (60) days after the FELLOW’s completion of the Licensure Examination (Section 6.1).' },
    { lead: 'Repayment Period.', text: 'Six (6) months, regardless of the amount of the Principal (Section 6.1).' },
  ...
  const sec6Illustration: LoanBlock = isTindig
    ? { lead: '6.1 Terms of Repayment.', text: 'Where the Cash Repayment Option applies, the FELLOW repays the Principal in three (3) equal consecutive monthly installments, the first falling due on the Repayment Commencement Date (sixty (60) days after completion of the Licensure Examination), with Interest equal to a flat ten percent (10%) of the Principal for the three (3)-month Repayment Period — equivalent to forty percent (40%) per annum — added to the Principal and spread equally across the installments. SCEI shall provide an amortization schedule before the first installment falls due. By way of illustration, a Principal of PHP 30,000.00 repaid over three (3) months entails a monthly installment of PHP 11,000.00, with total interest of PHP 3,000.00. A sample computation is attached as Annex “A” and forms an integral part of this Agreement.' }
    : { lead: '6.1 Terms of Repayment.', text: 'Where the Cash Repayment Option applies, the FELLOW repays the Principal in six (6) equal consecutive monthly installments, regardless of the amount of the Principal. The first falls due on the Repayment Commencement Date (sixty (60) days after completion of the Licensure Examination), with Interest equal to a flat ten percent (10%) of the Principal for the six (6)-month Repayment Period — equivalent to twenty percent (20%) per annum — added to the Principal and spread equally across the installments. SCEI shall provide an amortization schedule before the first installment falls due. By illustration: PHP 100,000.00 over six (6) months entails a monthly installment of approximately PHP 18,333.33, with total interest of PHP 10,000.00; PHP 50,000.00 over six (6) months entails approximately PHP 9,166.67 monthly, with total interest of PHP 5,000.00. Sample computations are attached as Annex “A” and form an integral part of this Agreement.' }

  const sec41 = isTindig ? 'in three (3) equal monthly installments, with Interest of a flat ten percent (10%) of the Principal for the three (3)-month Repayment Period (equivalent to forty percent (40%) per annum),' : 'in equal monthly installments over the Repayment Period of six (6) months, with Interest of a flat ten percent (10%) of the Principal for the six (6)-month Repayment Period (equivalent to twenty percent (20%) per annum),'
  ...
  const checks = isTindig ? 'three (3) post-dated checks' : 'six (6) post-dated checks'
...
export function annexIntro(isTindig: boolean): string {
  return isTindig
    ? 'The computation below is for illustration only. It assumes the maximum Principal under the Tindig Track of PHP 30,000.00, repaid in three (3) equal monthly installments, with a flat Interest of ten percent (10%) of the Principal for the three (3)-month Repayment Period (equivalent to forty percent (40%) per annum), in accordance with Section 6.1. The FELLOW’s actual amortization schedule shall be based on the Principal actually disbursed. No fee or charge other than the stated Interest applies. A FELLOW who discharges the Loan through the Service Condonation Option (Option A) pays nothing at all, and this Annex does not apply.'
    : 'The computations below are for illustration only. They assume repayment of the Principal in equal consecutive monthly installments over the Repayment Period of six (6) months, regardless of the amount of the Principal, with a flat Interest of ten percent (10%) of the Principal for the six (6)-month Repayment Period (equivalent to twenty percent (20%) per annum), in accordance with Section 6.1. The FELLOW’s actual amortization schedule shall be based on the Principal actually disbursed. No fee or charge other than the stated Interest applies. A FELLOW who discharges the Loan through the Service Condonation Option (Option A) pays nothing at all, and this Annex does not apply.'
}

export const annexNote =
  'Figures are rounded to the nearest centavo; the final installment is adjusted so that the Loan is fully paid on the last installment. Prepayment is allowed at any time without penalty, with the flat Interest reduced pro rata for the unelapsed months of the Repayment Period.'
...
export function annexTables(isTindig: boolean): AnnexTable[] {
  if (isTindig) {
    return [{
      ...
      rows: [
        ['1', '30,000.00', '11,000.00', '1,000.00', '10,000.00', '20,000.00'],
        ['2', '20,000.00', '11,000.00', '1,000.00', '10,000.00', '10,000.00'],
        ['3', '10,000.00', '11,000.00', '1,000.00', '10,000.00', '0.00'],
        ['Total', '—', '33,000.00', '3,000.00', '30,000.00', '0.00'],
      ],
    }]
  }
  return [
    {
      ...
      rows: [
        ['25,000.00', '6 months', '4,583.33', '2,500.00', '27,500.00'],
        ['50,000.00', '6 months', '9,166.67', '5,000.00', '55,000.00'],
        ['100,000.00', '6 months', '18,333.33', '10,000.00', '110,000.00'],
      ],
    },
    {
      ...
      headers: ['Month', 'Outstanding balance', 'Monthly installment', 'Interest portion', 'Principal portion', 'Balance after payment'],
      rows: [
        ['1', '100,000.00', '18,333.33', '1,666.67', '16,666.66', '83,333.34'],
        ['2', '83,333.34', '18,333.33', '1,666.67', '16,666.66', '66,666.68'],
        ['3', '66,666.68', '18,333.33', '1,666.67', '16,666.66', '50,000.02'],
        ['4', '50,000.02', '18,333.33', '1,666.67', '16,666.66', '33,333.36'],
        ['5', '33,333.36', '18,333.33', '1,666.67', '16,666.66', '16,666.70'],
        ['6', '16,666.70', '18,333.35', '1,666.65', '16,666.70', '0.00'],
        ['Total', '—', '110,000.00', '10,000.00', '100,000.00', '0.00'],
      ],
    },
  ]
}
