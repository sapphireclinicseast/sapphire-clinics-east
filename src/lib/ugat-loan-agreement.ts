...
//
// The Aral final uses "APPLICANT"; the Tindig final uses "FELLOW" — matched per
// track. Two annexes are referenced: Annex A (sample repayment computation) and
// Annex B (Joint Undertaking with Promissory Note).
...
export function loanAgreementBlocks(i: LoanInput): LoanBlock[] {
  ...
  const A = isTindig ? 'FELLOW' : 'APPLICANT'   // actor term, per the final docs
  ...
  const sec1: LoanBlock[] = isTindig ? [
    ...
    { lead: '1.2 The Grant.', text: 'The Assistance Amount is up to Thirty Thousand Pesos (PHP 30,000.00), availed — at the FELLOW’s written election, subject to SCEI’s approval — as (a) SCEI’s direct payment of licensure review fees (review program + materials) up to PHP 30,000.00; or (b) a monthly review stipend of PHP 5,000.00 for six (6) months during the Review Period. Under (a), SCEI pays only fees actually incurred; any shortfall is not paid out or refunded, and any excess is for the FELLOW’s account. Stipend availments are remitted to the FELLOW’s bank account on or before the 10th of each month; review-fee availments are paid directly to the provider or reimbursed against receipts. The determination of the Program Assessors is final.' },
    { lead: '1.3 Treatment and Acknowledgment.', text: 'The FELLOW and CO-MAKER expressly acknowledge that all sums received from SCEI under this Program shall be treated as a simple loan.' },
  ...
  const sec3: LoanBlock[] = isTindig ? [
    ...
    { lead: '3.1 Discontinuance of Review.', text: 'Should the FELLOW abandon or discontinue the review, or fail to sit for the Licensure Examination as required, further disbursements cease as of that date, and the Assistance Amount actually received is settled in up to three (3) equal monthly installments, free from any interest or charge, commencing ninety (90) days from discontinuance. Full settlement finally discharges the Parties’ obligations. SCEI may, with compassion, waive, reduce, or restructure the amount due — particularly for serious illness, a death in the immediate family, or circumstances beyond the FELLOW’s control — and may, upon eventual licensure, allow discharge of the balance through the Service Condonation Option on proportionate terms.' },
    { lead: '3.2 One-Time Award.', text: 'The Grant is a one-time award, fixed at a maximum of PHP 30,000.00, and shall not be increased, renewed, or extended under any circumstance, including any extension of the Review Period or any retaking of the Licensure Examination. Any review beyond the Grant is at the FELLOW’s own cost. Both modes of settlement under Section 4 remain fully available upon eventual licensure.' },
  ] : [
    { h: '3. TERMS AND CONDITIONS OF THE PROGRAM' },
...
export function annexIntro(isTindig: boolean): string {
  return isTindig
    ? 'The computation below is for illustration only. It assumes the maximum Assistance Amount under the Tindig Track of PHP 30,000.00, repaid in three (3) equal monthly installments, without interest or any charge of any kind, per Section 4.4. The FELLOW’s actual schedule is based on the amount actually disbursed. The total repaid always equals — and never exceeds — the amount received. A FELLOW who settles through the Service Condonation Option (Option A) pays nothing at all, and this Annex does not apply.'
