...
const SITE_CONFIG = {
  ...
  brands: [
    ...
    { name: 'UGAT Fellowship',         imgSrc: 'BRANDS/UGAT FELLOWSHIP.png',   link: 'ugat' },
  ],
  ...
  branches: {
    east: {
      ...
      facilities: [
        { name: 'Pediatric Gym',        img: 'AHEA FACILITY PHOTOS/PEDIATRIC GYM.png' },
        { name: 'Pediatric Gym II',     img: 'AHEA FACILITY PHOTOS/PEDIATRIC GYM-2.png' },
        { name: 'Pediatric Rooms',      img: 'AHEA FACILITY PHOTOS/PEDIATRIC ROOMS.png' },
        { name: 'SPED Room',            img: 'AHEA FACILITY PHOTOS/SPED ROOM.png' },
        { name: 'Adult Therapy Room 1', img: 'AHEA FACILITY PHOTOS/ADULT THERAPY ROOM 1.png' },
        { name: 'Adult Therapy Room 2', img: 'AHEA FACILITY PHOTOS/ADULT THERAPY ROOM 2.png' },
        { name: 'Adult Therapy Room 3', img: 'AHEA FACILITY PHOTOS/ADULT THERAPY ROOM 3.png' },
        { name: 'Cubicles Room',        img: 'AHEA FACILITY PHOTOS/CUBICLES ROOM.png' },
        { name: 'Cubicles Room II',     img: 'AHEA FACILITY PHOTOS/CUBICLES ROOM-2.png' },
        { name: 'Multisensory Room',    img: 'AHEA FACILITY PHOTOS/MULTISENSORY ROOM.png' },
        { name: 'Psychotherapy Room',   img: 'AHEA FACILITY PHOTOS/PSYCHOTHERAPY ROOM.png' },
        { name: 'Consultation Suite',   img: 'AHEA FACILITY PHOTOS/CONSULTATION SUITE.png' },
        { name: 'Adult Therapy Gym',    img: 'AHEA FACILITY PHOTOS/ADULT THERAPY GYM.png' },
    ...
    greenhills: {
      ...
      facilities: [
        { name: 'Assessment Suite',         img: 'AHGH FACILITY PHOTOS/ASSESSMENT SUITE.png' },
        { name: 'Care Pods',                img: 'AHGH FACILITY PHOTOS/CARE PODS-2.png' },
        { name: 'Child Development Suite',  img: 'AHGH FACILITY PHOTOS/CHILD DEVELOPMENT SUITE.png' },
        { name: 'Consultation Suite 1',     img: 'AHGH FACILITY PHOTOS/CONSULTATION SUITE 1.png' },
        { name: 'Consultation Suite 2',     img: 'AHGH FACILITY PHOTOS/CONSULTATION SUITE 2.png' },
        { name: 'Consultation Suite 3',     img: 'AHGH FACILITY PHOTOS/CONSULTATION SUITE 3.png' },
        { name: 'Early Steps Studio',       img: 'AHGH FACILITY PHOTOS/EARLY STEPS STUDIO.png' },
        { name: 'Inclusive Learning Studio',img: 'AHGH FACILITY PHOTOS/INCLUSIVE LEARNING STUDIO.png' },
        { name: 'Life Skills Studio I',     img: 'AHGH FACILITY PHOTOS/LIFE SKILLS STUDIO-1.png' },
        { name: 'Life Skills Studio II',    img: 'AHGH FACILITY PHOTOS/LIFE SKILLS STUDIO-2.png' },
        { name: 'Media & Motions Lab',      img: 'AHGH FACILITY PHOTOS/MEDIA AND MOTIONS LAB.png' },
        { name: 'Pantry & Lounge',          img: 'AHGH FACILITY PHOTOS/PANTRY AND LOUNGE.png' },
        { name: 'Pantry & Lounge II',       img: 'AHGH FACILITY PHOTOS/PANTRY AND LOUNGE-2.png' },
        { name: 'Pediatric Gym I',          img: 'AHGH FACILITY PHOTOS/PEDIATRIC GYM-1.png' },
        { name: 'Pediatric Gym II',         img: 'AHGH FACILITY PHOTOS/PEDIATRIC GYM-2.png' },
        { name: 'Pediatric Gym III',        img: 'AHGH FACILITY PHOTOS/PEDIATRIC GYM-3.png' },
